...
@section('seo')
<title>پکتو | ویدیو مارکتینگ</title>
      ...
      <div class="container pt-19 pt-md-21 pb-18 pb-md-20 text-center">
        <div class="row">
          <div class="col-md-10 col-lg-8 col-xl-7 col-xxl-6 mx-auto">
            <h1 class="display-1 text-white mb-3">Video Marketing</h1>
            <p class="lead fs-lg px-md-3 px-lg-7 px-xl-9 px-xxl-10">Visualize Your Brand Story With Video Marketing Services</p>
          </div>
          <!-- /column -->
        </div>
        <!-- /.row -->
    ...
    <section class="wrapper bg-light">
      <div class="container pt-14 pb-12 pt-md-16 pb-md-14">
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-lg-22 mb-xl-24 align-items-center">
          ...
          <!--/column -->
          <div class="col-lg-5">
            <h3 class="display-4 mb-5">84% of Customers Make a Purchase After Watching An Explainer Video</h3>
            <p>Our in-house designers and video marketing editors work hand-in-hand to solve all your creative and branded programming challenges. Draw your audience in with engaging videography and powerful visual storytelling with the help of our creative minds.</p>
          </div>
          <!--/column -->
        </div>
        <!--/.row -->
      ...
      <div class="container py-14 pt-md-16 pt-lg-0 pb-md-16">
        ...
        <div class="row text-center">
          <div class="col-lg-9 mx-auto">
            ...
            <h3>Results driven video marketing campaigns that help you increase brand awareness and improve audience engagement.</h3>
    ...
    <section class="wrapper bg-light">
      <div class="container py-14 py-md-16">
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
          ...
          <!--/column -->
          <div class="col-lg-5">
            <h3 class="display-4 mb-5">66% of Consumers Prefer Short Videos To Learn About A Product or Service</h3>
						<h3>Online videos are a way to communicate your brand voice, values, people, culture, and the community you foster.</h3>
            <p class="mb-6">We make it easy to show all the complexities your brand has to offer through cohesive, concise, and clever videos. We will help you distill your message into a palatable and engaging experience using video production.</p>
          </div>
          <!--/column -->
        </div>
        <!--/.row -->
