...
@section('seo')
<title>پکتو | ایمیل مارکتینگ</title>
      ...
      <div class="container pt-19 pt-md-21 pb-18 pb-md-20 text-center">
        <div class="row">
          <div class="col-md-10 col-lg-8 col-xl-7 col-xxl-6 mx-auto">
            <h1 class="display-1 text-white mb-3">Email Marketing</h1>
            <p class="lead fs-lg px-md-3 px-lg-7 px-xl-9 px-xxl-10">Email Marketing Agency Targeting Conversion and Retention</p>
          </div>
          <!-- /column -->
        </div>
        <!-- /.row -->
    ...
    <section class="wrapper bg-light">
      <div class="container pt-14 pb-12 pt-md-16 pb-md-14">
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-lg-22 mb-xl-24 align-items-center">
          ...
          <!--/column -->
          <div class="col-lg-5">
            <h3 class="display-4 mb-5">Strengthen Customer Relationships Through Email List Segmentation</h3>
            <p>Forget one-size-fits-all: we create specific audience segments based on historical user behavior to establish strong relationships with current and potential customers. By analyzing consumer drop off points and engagement rates, we use segmentation to tailor your messaging in order to resonate with different points in the user journey.</p>
          </div>
          <!--/column -->
        </div>
        <!--/.row -->
      ...
      <div class="container py-14 pt-md-16 pt-lg-0 pb-md-16">
        ...
        <div class="row text-center">
          <div class="col-lg-9 mx-auto">
            ...
            <h3>Harness the direct line of communication to your target audience through segmentation, automation and personalization.</h3>
    ...
    <section class="wrapper bg-light">
      <div class="container py-14 py-md-16">
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-16 align-items-center">
          ...
          <!--/column -->
          <div class="col-lg-5">
            <h3 class="display-4 mb-6 pe-xxl-6">Personalization is at the Core of Effective Communication</h3>
            <p class="mb-6">Our team of storytellers and copywriting experts craft targeted email marketing campaigns catered to the personas and preferences of specific audience segments. With deliberate and personalized brand storytelling, we continuously craft hyper relevant emails that increase leads and drive conversions.</p>
            <!-- /.progress-list -->
          </div>
          <!--/column -->
        </div>
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
          ...
          <!--/column -->
          <div class="col-lg-5">
            <h3 class="display-4 mb-5">Automated Email Campaign Optimizations for Increased CTR</h3>
						<h2>Automate your email flows for optimal send times</h2>
            <p class="mb-6">We build data backed automated email flows that manage the who, what and when of your emails, so that every story is told to exactly the right person at exactly the right time. Through rapid experimentation, A/B testing frameworks and conditional flows, we build emails to drive up engagement and conversions, unlocking the highest delivery, open and clickthrough rates.</p>
          </div>
          <!--/column -->
        </div>
        <!--/.row -->
