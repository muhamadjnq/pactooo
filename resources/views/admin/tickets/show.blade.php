																...
																<div class="card-body">
																		<div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column m-sm-3 m-0">
																				...
																				<div>
																						...
																						<div class="mb-2 pt-1"><p class="mb-2">تاریخ ثبت تیکت: {{ \Hekmatinasser\Verta\Verta::instance($ticket->created_at)->formatJalaliDatetime() }}</p></div>
																				</div>
																		</div>
																</div>
														</div>
																...
																<div class="card-body">
																		<div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column m-sm-3 m-0">
																				<div class="mb-xl-0 mb-4 col-xl-9 col-md-8 col-12 mb-m">
																						...
																						<p>{{ $message->user->name }}:</p><p>{{ \Hekmatinasser\Verta\Verta::instance($message->created_at)->formatJalaliDatetime() }}</p>
								...
								<div class="modal-dialog modal-lg modal-simple modal-edit-user">
										<div class="modal-content p-3 p-md-5">
												<div class="modal-body">
														...
														<form class="row g-3" id="editUserForm" action="{{ route('admin.tickets.respond', $ticket->id) }}" method="POST">
																@csrf
								...
								<div class="modal-dialog modal-lg modal-simple modal-edit-user">
										<div class="modal-content p-3 p-md-5">
												<div class="modal-body">
														...
														<form class="row g-3" id="editstatusForm" action="{{ route('admin.tickets.updateStatus', $ticket->id) }}" method="POST">
																@csrf
															<div class="col-12 col-md-6">
