@extends('admin.layout')
    @section('content')
          ...
          <div class="breadcrumb-header justify-content-between">
    				<div class="my-auto">
    					<div class="d-flex">
    						<h4 class="content-title mb-0 my-auto">پنل مدیریت</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/مدیریت دسته بندی ها</span>
    					</div>
    				</div>
    				<a href="{{ route('admin.category.create') }}">
    						<button class="btn btn-instagram waves-effect waves-light" type="button">ایجاد دسته بندی جدید</button>
    				</a>
    			</div>
    			<br>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <table id="example-delete" class="table text-md-nowrap dataTable dtr-inline" role="grid" aria-describedby="example-delete_info" style="width: 1032px;">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="example-delete" rowspan="1" colspan="1" style="width: 200px;">نوع</th>
                        <th class="sorting" tabindex="0" aria-controls="example-delete" rowspan="1" colspan="1" style="width: 200px;">بودجه</th>
                        ...
                        <td>
                            <button class="btn btn-secondary pd-x-25 active" type="button"><a href="{{ route('admin.category.edit', $category) }}" style="color:white;">ویرایش</a></button>
                            <form action="{{ route('admin.category.destroy', $category) }}" method="POST" style="display: inline-block;">
                                ...
                                <button class="btn btn-secondary pd-x-25" type="submit" onclick="return confirm('آیا مطمئن هستید؟')">حذف</button>
    									...
    									<tr>
    									<td colspan="7" style="text-align: center">هیچ دسته بندیی ساخته نشده!</td>
    									</tr>
    									@endif
    										</tbody>
    								</table>
