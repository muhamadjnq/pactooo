...
@section('content')
      ...
      <div class="breadcrumb-header justify-content-between">
				<div class="my-auto">
					<div class="d-flex">
						<h4 class="content-title mb-0 my-auto">پنل مدیریت</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تماس با ما</span>
					</div>
				</div>
			</div>
					...
					<div class="card">
						<div class="card-header pb-0">
							<div class="d-flex justify-content-between">
								<h4 class="card-title mg-b-0">لیست تماس با ما</h4>
            ...
            <div class="row">
              <div class="col-sm-12">
                <table id="example-delete" class="table text-md-nowrap dataTable dtr-inline" role="grid" aria-describedby="example-delete_info" style="width: 1032px;">
									<thead>
										<tr role="row">
										<th class="sorting_asc" tabindex="0" aria-controls="example-delete" rowspan="1" colspan="1" style="width: 143px;" aria-label="نام: activate to sort column descending" aria-sort="ascending">نام</th>
										<th class="sorting" tabindex="0" aria-controls="example-delete" rowspan="1" colspan="1" style="width: 247px;" aria-label="ایمیل: activate to sort column ascending">ایمیل</th>
										<th class="sorting" tabindex="0" aria-controls="example-delete" rowspan="1" colspan="1" style="width: 118px;" aria-label="شماره تماس: activate to sort column ascending">شماره تماس</th>
										<th class="sorting" tabindex="0" aria-controls="example-delete" rowspan="1" colspan="1" style="width: 118px;" aria-label="پیام: activate to sort column ascending">پیام</th>
                    <th class="sorting" tabindex="0" aria-controls="example-delete" rowspan="1" colspan="1" style="width: 68px;" aria-label="پیام: activate to sort column ascending">پیام</th>
										</tr>
									</thead>
									<tbody>
                    @foreach ($contacts as $key => $contact)
  									<tr role="row" class="odd">
                      <th class="sorting_1" tabindex="0">{{ $contact->name }}</th>
  										<td>{{ $contact->email }}</td>
  										<td>{{ $contact->phone }}</td>
  										<td>{{ $contact->text }}</td>
  									</tr>
  									...
  									@if(count($contacts) == 0)
                    <tr>
                      <td colspan="7" style="text-align: center">هیچ پیامی ثبت نشده!</td>
                    </tr>
                    @endif
										</tbody>
								</table>
