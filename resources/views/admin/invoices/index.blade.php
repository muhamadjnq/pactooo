...
<div class="container-fluid">
  ...
  <div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
      <div class="d-flex">
        <h4 class="content-title mb-0 my-auto">پنل مدیریت</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/مدیریت فاکتورها</span>
      </div>
    </div>
  </div>
  <br>
      ...
      <div class="card">
        <div class="card-header pb-0">
          <div class="d-flex justify-content-between">
            <h4 class="card-title mg-b-0">لیست فاکتورها</h4>
        ...
        <div class="row">
          <div class="col-sm-12">
            <table id="example-delete" class="table text-md-nowrap dataTable dtr-inline" role="grid" aria-describedby="example-delete_info" style="width: 1032px;">
              <thead>
                <th class="sorting" tabindex="0" aria-controls="example-delete" rowspan="1" colspan="1" style="width: 200px;">شماره فاکتور</th>
                <th class="sorting" tabindex="0" aria-controls="example-delete" rowspan="1" colspan="1" style="width: 200px;">سفارش</th>
                <th class="sorting" tabindex="0" aria-controls="example-delete" rowspan="1" colspan="1" style="width: 200px;">کاربر</th>
                <th class="sorting" tabindex="0" aria-controls="example-delete" rowspan="1" colspan="1" style="width: 200px;">مبلغ کل</th>
              ...
              <tbody>
                @foreach($invoices as $invoice)
                    <tr role="row" class="odd">
                        ...
                        <td>{{ \Hekmatinasser\Verta\Verta::instance($invoice->invoice_date)->formatJalaliDatetime() }}</td>
                        <td>
                            <button class="btn btn-primary" type="button"><a href="{{ route('admin.invoices.show', $invoice) }}" style="color:white;">مشاهده</a></button>
                        </td>
                    </tr>
                @endforeach
              @if(count($invoices) == 0)
              <tr>
              <td colspan="7" style="text-align: center">هیچ فاکتوری ساخته نشده!</td>
              </tr>
              @endif
                </tbody>
            </table>
