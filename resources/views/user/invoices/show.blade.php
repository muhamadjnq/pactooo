...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between mt-4">
        <a href="{{ route('user.invoices.index') }}" class="btn btn-secondary">بازگشت به لیست فاکتورها</a>
        <a href="{{ route('user.invoices.download-pdf', $invoice) }}" class="btn btn-primary">دانلود PDF</a>
    </div>
</div>
@endsection
